...
import { deleteRoom, getRoomTypes, postRoom, putRoomType, RoomType } from "~/fetch/roomType"
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2">
                            Manage room types and their rental prices
                        </p>
                    </div>
                        ...
                        <DialogContent className="sm:max-w-md">
                            <DialogHeader>
                                <DialogTitle className="flex items-center gap-2">
                                    {editingRoomType ? <Edit className="h-5 w-5" /> : <Plus className="h-5 w-5" />}
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.RoomTypeName && (
                                        <p className="text-sm text-destructive">{errors.RoomTypeName}</p>
                                    )}
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.RentPrice && (
                                        <p className="text-sm text-destructive">{errors.RentPrice}</p>
                                    )}
                                </div>
                                ...
                                <div className="flex gap-2">
                                    <Button
                                        onClick={editingRoomType ? handleUpdateRoomType : handleCreateRoomType}
